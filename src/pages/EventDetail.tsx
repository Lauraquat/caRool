    ...
    <IonPage>
      ...
      <IonContent id="contentTest" fullscreen>
        ...
        <section className='event-detail-content'>
          <h1>{event?.titre}</h1>
          <p>{event?.date.toDate().toLocaleDateString('fr-FR', { day: 'numeric', month: 'long', year: 'numeric' })} {event?.date.toDate().toLocaleTimeString('fr-FR', { hour: 'numeric', minute: 'numeric' })}</p>
